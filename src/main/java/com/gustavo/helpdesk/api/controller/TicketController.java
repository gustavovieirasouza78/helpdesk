package com.gustavo.helpdesk.api.controller;
...
import com.gustavo.helpdesk.api.dto.Summary;
...
import com.gustavo.helpdesk.api.response.Response;
import com.gustavo.helpdesk.api.security.jwt.JwtTokenUtil;
...
public class TicketController {
    ...
    @PreAuthorize("hasAnyRole('CUSTOMER','TECHNICIAN')")
    public  ResponseEntity<Response<Page<Ticket>>> findAll(HttpServletRequest request, @PathVariable int page, @PathVariable int count) throws Exception {
    ...
    public  ResponseEntity<Response<Page<Ticket>>> findByParams(HttpServletRequest request,
                                                                ...
                                                                @PathVariable boolean assigned) throws Exception {
